...
class TestValidateTaskForm:
    ...
    def test_valid_task_with_title_and_description(self):
        ...
        form_data = {"title": "Buy groceries", "description": "Milk, eggs, and bread"}
    ...
    def test_valid_task_with_title_only(self):
        ...
        form_data = {"title": "Buy groceries", "description": ""}
        errors, cleaned_data = validate_task_form(form_data)
    ...
    def test_missing_title(self):
        ...
        form_data = {"title": "", "description": "Some description"}
        errors, cleaned_data = validate_task_form(form_data)
    ...
    def test_title_too_long(self):
        ...
        long_title = "a" * 256
        form_data = {"title": long_title, "description": "Some description"}
        errors, cleaned_data = validate_task_form(form_data)
    ...
    def test_title_exactly_255_characters(self):
        ...
        title_255 = "a" * 255
        form_data = {"title": title_255, "description": ""}
        errors, cleaned_data = validate_task_form(form_data)
    ...
    def test_description_too_long(self):
        ...
        form_data = {"title": "Valid title", "description": long_description}
        errors, cleaned_data = validate_task_form(form_data)
    ...
    def test_description_exactly_255_characters(self):
        ...
        form_data = {"title": "Valid title", "description": description_255}
        errors, cleaned_data = validate_task_form(form_data)
    ...
    def test_whitespace_stripping(self):
        ...
        form_data = {"title": "  Buy groceries  ", "description": "  Milk and eggs  "}
        errors, cleaned_data = validate_task_form(form_data)
    ...
    def test_multiple_validation_errors(self):
        ...
        form_data = {"title": "", "description": "x" * 256}
        errors, cleaned_data = validate_task_form(form_data)
